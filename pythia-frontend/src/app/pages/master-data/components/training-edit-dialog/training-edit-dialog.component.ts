...
/**
 * Training Edit Dialog Component
 *
 * Purpose: Modal dialog for creating and editing training entries
 * Features:
...
@Component({
  ...
  styleUrl: './training-edit-dialog.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class TrainingEditDialogComponent implements OnInit {
  private readonly fb = inject(FormBuilder);
  protected readonly dialogRef = inject(MatDialogRef<TrainingEditDialogComponent>);
  protected readonly data = inject<TrainingEditDialogData>(MAT_DIALOG_DATA);
  ...
  protected get dialogTitle(): string {
    return this.isEditMode ? 'Edit Training' : 'Add New Training';
  }
