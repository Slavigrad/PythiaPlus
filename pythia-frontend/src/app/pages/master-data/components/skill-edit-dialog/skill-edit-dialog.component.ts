 ...
 *
 * Purpose: Modal dialog for creating and editing skill entries
 * Features:
...
export class SkillEditDialogComponent implements OnInit {
  ...
  protected readonly dialogRef = inject(MatDialogRef<SkillEditDialogComponent>);
  protected readonly data = inject<SkillEditDialogData>(MAT_DIALOG_DATA);
  ...
  protected get dialogTitle(): string {
    return this.isEditMode ? 'Edit Skill' : 'Add New Skill';
  }
